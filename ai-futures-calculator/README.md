...
| :---- | :---- |
 ...
 | scripts/plot\_rollouts.py | CLI to plot AC time histogram, horizon trajectories, and horizon-at-AC distributions from a run; saves PNGs to the run directory. |
