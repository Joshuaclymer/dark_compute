...
tool_types = ['DUV_scanner', 'Photoresist', 'Overlay_metrology', 'Ion_implanter', 'Electroplating', 'deposition', 'etch']
tool_display_names = {
...
plt.tight_layout()
plt.savefig('china_timeline_table.png', dpi=300, bbox_inches='tight')
print("Color-coded timeline table saved to china_timeline_table.png")
