"""
TakeoffModel class for AI progress trajectory predictions with Monte Carlo sampling.

This module wraps the ai-futures-calculator takeoff model, providing:
1. Monte Carlo sampling of parameters at initialization
2. Agreement start year determination based on AI R&D speedup thresholds
3. Trajectory prediction using the underlying takeoff model
"""
