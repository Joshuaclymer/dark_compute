...
class BlackProjectSimulation:
    ...
    def __init__(
            self,
            covert_projects: dict[str, CovertPRCInfrastructure],
...
class BlackProjectModel:
    ...
    def _init_covert_projects(self, agreement_year: float, simulation_end_year: float):
        ...
        Returns:
            dict: Dictionary of covert project names to CovertPRCInfrastructure instances
        """
        ...
        return {
            "prc_covert_project" : CovertPRCInfrastructure(
    ...
    def run_simulations(self, num_simulations: int):
        ...
        agreement_year = self.parameters.simulation_settings.start_agreement_at_specific_year
