// JavaScript for Dark Compute Model - Rate of Computation Section

function plotDarkComputeRateSection(data) {
    ...
    if (data.black_project_model && data.black_project_model.survival_rate) {
        const years = data.black_project_model.years;
        const survival_rate_median = data.black_project_model.survival_rate.median;
        const survival_rate_p25 = data.black_project_model.survival_rate.p25;
        const survival_rate_p75 = data.black_project_model.survival_rate.p75;
    ...
    if (data.black_project_model && data.black_project_model.total_black_project) {
        const years = data.black_project_model.years;
        const black_project_median = data.black_project_model.total_black_project.median;
        const black_project_p25 = data.black_project_model.total_black_project.p25;
        const black_project_p75 = data.black_project_model.total_black_project.p75;
    ...
    let sharedYMax = 0;
    if (data.black_project_model && data.black_project_model.datacenter_capacity && data.black_project_model.black_project_energy) {
