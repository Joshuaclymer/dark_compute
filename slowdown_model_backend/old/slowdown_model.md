...
There are three actors that we model during the slowdown
...
We also model a couple of counterfactual actors:
- The largest US company if there was no slowdown. 
- The largest PRC project if there was no slowdown. 

The rest of this document, however, focuses on the first three.
...
During the cease training phase, 
