...
def params_to_dict(params: Parameters):
    ...
    param_dict = {
        ...
        'asi_above_siar_vs_tedai_above_sar_difficulty': getattr(params, 'asi_above_siar_vs_tedai_above_sar_difficulty', 4.0),
    }
    ...
    try:
        ...
        parameter_config = {
            ...
            'descriptions': {
                ...
                'ted_ai_m2b': {
                    'name': 'TED-AI M2Bs',
                    'description': 'Number of median-to-bests above SAR for TED-AI milestone',
                    'units': 'M2Bs'
                },
                'asi_above_siar_vs_tedai_above_sar_difficulty': {
                    'name': 'ASI M2Bs Above SIAR vs TED-AI Above SAR',
                    'description': 'ASI difficulty above SIAR vs TED-AI above SAR (ASI M2Bs = 2 + this)',
                    'units': 'M2Bs'
                }
            }
        }
...
def get_default_data():
    ...
    return jsonify({
        ...
        'parameters': {
            ...
            'asi_above_siar_vs_tedai_above_sar_difficulty': params.asi_above_siar_vs_tedai_above_sar_difficulty
        }
    })
