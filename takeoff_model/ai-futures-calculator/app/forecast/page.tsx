...
async function loadConditionalTimingDistributions(year: number): Promise<ConditionalTimingData> {
  ...
  return {
    milestones: filteredMilestones,
    statistics: filteredStatistics,
    conditionDescription: `Time until milestone achievement, conditional on achieving AC (Automated Coder) within ${year}`,
  };
}
        ...
        <main className="mt-10 mx-auto max-w-5xl px-6 pb-16">
          <section className="space-y-8">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              We estimated each parameter in the model, quantified our uncertainty as a probability distribution over each one, then simulated thousands of possible trajectories. Here are the results.
            </p>
          ...
          <section className="space-y-8 mt-16">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              We find that shorter timelines to the Automated Coder milestone correlate with faster takeoff to superintelligence. We are substantially more uncertain after takeoff speeds farther into the future. One reason is because our model relies on exogenous compute forecasts which are increasingly speculative in the late 2030s and beyond. 
            </p>
            <p className="text-base leading-relaxed text-gray-600">
