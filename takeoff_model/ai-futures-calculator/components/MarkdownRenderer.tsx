  ...
  return (
    <ReactMarkdown 
      ...
      components={{
        ...
        h1: ({ id, children }) => <h1 id={id} className="text-2xl font-bold">{children}</h1>,
        h2: ({ id, children }) => <h2 id={id} className="text-xl font-bold">{children}</h2>,
        h3: ({ id, children }) => <h3 id={id} className="text-lg font-bold">{children}</h3>,
        h4: ({ id, children }) => <h4 id={id} className="text-base font-bold">{children}</h4>,
        h5: ({ id, children }) => <h5 id={id} className="text-sm font-bold">{children}</h5>,
        h6: ({ id, children }) => <h6 id={id} className="text-xs font-bold">{children}</h6>,
        ...
        a: ({ href, children, className }) => {
          ...
          // External links
          return <a href={href && stripGoogleUrlRedirect(href)} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent/80">{children}</a>;
        },
        img: ({ src, alt }) => <img src={src} alt={alt} className="mb-4 mx-auto mix-blend-darken" />,
