...
export const MILESTONE_EXPLANATIONS: Record<string, string> = {
  'AC': 'An AC can (if dropped into present day) autonomously replace the AGI project\'s coding staff without human help, given 5% of the projects\' compute.',
  'SAR': 'A SAR has experiment selection skill matching the top AGI project researcher.',
  'SIAR': 'A SIAR is 2 times as far above the top AGI project researcher as the top AGI project researcher is above the median. (That ism 2x more SDs within the human distribution, not necessarily a full 2x larger difference in experiment selection skill values)',
...
export const SMALL_CHART_EXPLANATIONS = {
  ...
  inferenceCompute: 'The amount of compute used by the leading AI company for automating coding.',
  // Experiment Compute
  experimentCompute: 'The amount of compute used by the leading AI company for running experiments.',
  // Human Coding Labor
