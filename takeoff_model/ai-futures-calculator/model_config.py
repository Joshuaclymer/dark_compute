...
PARAMETER_BOUNDS = {
    ...
    'ted_ai_m2b': (0.01, 100.0),    # TED-AI median-to-bests above SAR
    'asi_above_siar_vs_tedai_above_sar_difficulty': (0.01, 100.0),  # ASI difficulty above SIAR vs TED-AI above SAR (ASI m2b = 2 + this)
...
DEFAULT_PARAMETERS = {
    ...
    'ted_ai_m2b': 3.0,    # TED-AI is 4 M2Bs above SAR
    'asi_above_siar_vs_tedai_above_sar_difficulty': 0.8,  # ASI is 2 + this M2Bs * ted_ai_m2bs above SAR
    ...
    'weight_stealing_mode': False,
    'years_weights_are_stolen': None,  # List of decimal years or milestone names when weights are stolen
    'stealing_algorithms_up_to': None,  # Time or milestone up to which algorithms are stolen (same software efficiency)
